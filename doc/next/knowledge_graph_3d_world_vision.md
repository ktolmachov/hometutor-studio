...
| одновременно ≤1 «сценка» угрозы | ✅ `fullThreatSceneAllowed` / `refreshThreatSceneFocus` |
| угроза без действия ≤2 мин → hide | ✅ `THREAT_SCENE_TTL_MS` + `noteThreatSceneInteraction` |
...
| 3 | Threat TTL ≤2 min / ≤1 сцена | ✅ residual 2026-07-18 | template dosage helpers + structural tests |
