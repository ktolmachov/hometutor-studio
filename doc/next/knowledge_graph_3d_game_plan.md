...
| **G4** прогрессия/реплей | 🟡 partial | **G4.1+G4.2 @275** ✅ · **G4.3 photo** ⬜ (privacy DoD) |
...
- R1 chrome · R2 toast · R3 hall — **@271–272** ✅  
- W0 Q1–Q9 (axis/nav, compass, fitCamera, status, links, smooth path, ring) — **@273–274** ✅  
- G4.1 floor tint · G4.2 history replay — **@275** ✅  
...
| Camera / mobile | crop на 390 | ✅ W0 `fitRouteCamera` margin clamp |
| G4 этажи / реплей | — | ✅ G4.1 tint local/all · G4.2 `#replaybar` |
| G4 фото дня | — | ⬜ не начат |
