...
**G4 (@275):** G4.1 floor tint ✅ · G4.2 history scrubber/replay ✅ · G4.3 photo ⬜.  
**Осталось:** G4.3 (privacy DoD); Мнемополис vision (разбор №19).
...
| G4 прогрессия/реплей | — | ✅ G4.1+G4.2 @275 · ⬜ G4.3 photo |
