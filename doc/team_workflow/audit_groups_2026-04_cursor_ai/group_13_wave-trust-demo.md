...
- Packages: 1
- Waves: wave-trust-demo
- CJM moments: #10 Retrieval trust
- User stories in April index: US-2.2
- CI miss: 0
- US miss: 0
- CJM cross-links to other groups: #10 Retrieval trust -> groups [8, 10, 13, 15]

## Packages

| # | Package ID | Date | Wave | CI | US | CJM | Title |
|---:|---|---|---|---|---|---|---|
| 1 | epoch-demo-scenario-08-trust | 2026-04-25 | wave-trust-demo | OK | OK | #10 Retrieval trust | Demo доказывает anti-hallucination: каждый тезис → фрагмент → строка в файле. Local-first. |
...
Use this file as a standalone Cursor AI prompt for completing DoD test coverage for `group_13_wave-trust-demo.md`.
It follows `archive/doc_team_workflow/audit_coverage_prompt_2026-04_cursor_ai.md`, but is scoped to this group only.

## Inputs

- This group file: `doc/team_workflow/audit_groups_2026-04_cursor_ai/group_13_wave-trust-demo.md`
...
- Packages: 1
- PASS: 1 (completed audit group 13 — см. `archive/team_artifacts/audit_2026-04/group_13_dod_coverage_report.md`)
- PARTIAL: 0
...
|---|---|---|---|
| `epoch-demo-scenario-08-trust` | dod, e2e, pytest YAML/offline contract | — | source-trust/citation assertion |
...
- Group intent focus: #10 Retrieval trust.
...
1. `epoch-demo-scenario-08-trust`
...
```powershell
Select-String -Path doc/closed_iterations.md -Pattern "epoch\-demo\-scenario\-08\-trust"
Select-String -Path doc/cjm.md -Pattern "US\-2\.2|\#10\ Retrieval\ trust"
Select-String -Path doc/team_workflow/audit_groups_2026-04_cursor_ai/coverage_dod_analysis.md -Pattern "epoch\-demo\-scenario\-08\-trust"
```

Before editing tests for a package, run a scoped read-set check:

```powershell
.\.venv\Scripts\python.exe scripts/check_readset.py doc/backlog_registry.yaml doc/user_stories_index.json doc/team_workflow/audit_groups_2026-04_cursor_ai/group_13_wave-trust-demo.md
```
...
`archive/team_artifacts/audit_2026-04/group_13_dod_coverage_report.md`

Required format:

```markdown
# DoD Coverage Completion ? Group 13
