...
- Packages: 2
- Waves: wave-flashcard-polish
- CJM moments: #11 Flashcard creation, #12 Flashcard review
- User stories in April index: none
- CI miss: 0
- US miss: 2
- CJM cross-links to other groups: none

## Packages

| # | Package ID | Date | Wave | CI | US | CJM | Title |
|---:|---|---|---|---|---|---|---|
| 1 | epoch-flashcard-deck-mgmt | 2026-04-22 | wave-flashcard-polish | OK | MISS | #11 Flashcard creation, #12 Flashcard review | Learner может редактировать/удалять карточки и колоды из UI; CTA «Создать карточки из квиза» созд... |
| 2 | epoch-flashcard-export-upload | 2026-04-23 | wave-flashcard-polish | OK | MISS | #12 Flashcard review | Экспорт колоды в Anki .apkg; загрузка PDF/text файла из UI для генерации карточек |

## Strong Relations Inside This Group

- `epoch-flashcard-deck-mgmt` <-> `epoch-flashcard-export-upload`: depends_on:epoch-flashcard-deck-mgmt, wave:wave-flashcard-polish

## Coverage Completion Prompt

Use this file as a standalone Cursor AI prompt for completing DoD test coverage for `group_05_wave-flashcard-polish.md`.
It follows `archive/doc_team_workflow/audit_coverage_prompt_2026-04_cursor_ai.md`, but is scoped to this group only.

## Inputs

- This group file: `doc/team_workflow/audit_groups_2026-04_cursor_ai/group_05_wave-flashcard-polish.md`
...
|---|---|---|---|
| `epoch-flashcard-deck-mgmt` | unit | GAP_E2E_OR_UI_SMOKE, GAP_DOD_COMMAND | flashcard learner path assertion |
| `epoch-flashcard-export-upload` | unit | GAP_E2E_OR_UI_SMOKE, GAP_DOD_COMMAND | flashcard learner path assertion |
...
- Group intent focus: #11 Flashcard creation, #12 Flashcard review.
...
1. `epoch-flashcard-deck-mgmt`
2. `epoch-flashcard-export-upload`
...
```powershell
Select-String -Path doc/closed_iterations.md -Pattern "epoch\-flashcard\-deck\-mgmt|epoch\-flashcard\-export\-upload"
Select-String -Path doc/cjm.md -Pattern "\#11\ Flashcard\ creation|\#12\ Flashcard\ review"
Select-String -Path doc/team_workflow/audit_groups_2026-04_cursor_ai/coverage_dod_analysis.md -Pattern "epoch\-flashcard\-deck\-mgmt|epoch\-flashcard\-export\-upload"
```

Before editing tests for a package, run a scoped read-set check:

```powershell
.\.venv\Scripts\python.exe scripts/check_readset.py doc/backlog_registry.yaml doc/user_stories_index.json doc/team_workflow/audit_groups_2026-04_cursor_ai/group_05_wave-flashcard-polish.md
```
...
`archive/team_artifacts/audit_2026-04/group_05_dod_coverage_report.md`

Required format:

```markdown
# DoD Coverage Completion ? Group 05
