...
- Packages: 1
- Waves: wave-token-safety-ingestion
- CJM moments: infra
...
|---:|---|---|---|---|---|---|---|
| 1 | epoch-ingestion-loader-token-registry | 2026-04-29 | wave-token-safety-ingestion | OK | MISS | infra | Добавить app/ingestion_loader.py в doc/token_safety_registry.json: full_read forbidden, est_token... |
...
Use this file as a standalone Cursor AI prompt for completing DoD test coverage for `group_14_wave-token-safety-ingestion.md`.
It follows `archive/doc_team_workflow/audit_coverage_prompt_2026-04_cursor_ai.md`, but is scoped to this group only.

## Inputs

- This group file: `doc/team_workflow/audit_groups_2026-04_cursor_ai/group_14_wave-token-safety-ingestion.md`
...
- Packages: 1
- PASS: 1 (формализовано в audit group 14 — см. `archive/team_artifacts/audit_2026-04/group_14_dod_coverage_report.md`)
- PARTIAL: 0
...
|---|---|---|---|
| `epoch-ingestion-loader-token-registry` | dod, unit, cli/schema | — | CLI/schema/policy regression for infra behavior |
...
1. `epoch-ingestion-loader-token-registry`
...
```powershell
Select-String -Path doc/closed_iterations.md -Pattern "epoch\-ingestion\-loader\-token\-registry"
Select-String -Path doc/cjm.md -Pattern "infra"
Select-String -Path doc/team_workflow/audit_groups_2026-04_cursor_ai/coverage_dod_analysis.md -Pattern "epoch\-ingestion\-loader\-token\-registry"
```

Before editing tests for a package, run a scoped read-set check:

```powershell
.\.venv\Scripts\python.exe scripts/check_readset.py doc/backlog_registry.yaml doc/user_stories_index.json doc/team_workflow/audit_groups_2026-04_cursor_ai/group_14_wave-token-safety-ingestion.md
```
...
`archive/team_artifacts/audit_2026-04/group_14_dod_coverage_report.md`

Required format:

```markdown
# DoD Coverage Completion ? Group 14
