...
- Packages: 1
- Waves: wave-plan-visibility
- CJM moments: #6 Adaptive plan
...
|---:|---|---|---|---|---|---|---|
| 1 | epoch-plan-diff-ux | 2026-04-22 | wave-plan-visibility | OK | MISS | #6 Adaptive plan | Expander «Что изменилось» в Adaptive Plan card показывает diff added/removed concepts vs предыдущ... |
...
Use this file as a standalone Cursor AI prompt for completing DoD test coverage for `group_12_wave-plan-visibility.md`.
It follows `archive/doc_team_workflow/audit_coverage_prompt_2026-04_cursor_ai.md`, but is scoped to this group only.

## Inputs

- This group file: `doc/team_workflow/audit_groups_2026-04_cursor_ai/group_12_wave-plan-visibility.md`
...
|---|---|---|---|
| `epoch-plan-diff-ux` | unit | GAP_E2E_OR_UI_SMOKE, GAP_DOD_COMMAND | progress/plan learner assertion |
...
- Group intent focus: #6 Adaptive plan.
...
```powershell
Select-String -Path doc/closed_iterations.md -Pattern "epoch\-plan\-diff\-ux"
Select-String -Path doc/cjm.md -Pattern "\#6\ Adaptive\ plan"
Select-String -Path doc/team_workflow/audit_groups_2026-04_cursor_ai/coverage_dod_analysis.md -Pattern "epoch\-plan\-diff\-ux"
```

Before editing tests for a package, run a scoped read-set check:

```powershell
.\.venv\Scripts\python.exe scripts/check_readset.py doc/backlog_registry.yaml doc/user_stories_index.json doc/team_workflow/audit_groups_2026-04_cursor_ai/group_12_wave-plan-visibility.md
```
...
`archive/team_artifacts/audit_2026-04/group_12_dod_coverage_report.md`

Required format:

```markdown
# DoD Coverage Completion ? Group 12
