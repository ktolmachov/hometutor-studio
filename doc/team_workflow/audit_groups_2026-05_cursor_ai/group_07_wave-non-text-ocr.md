# Audit group group_07 — Non-text ingest / OCR
...
| # | Package ID |
|---:|---|
| 1 | `epoch-ocr-docling-ingest-phase1` |
| 2 | `epoch-ocr-docling-story-gate` |
| 3 | `epoch-us-2.3-non-text-corpus-contract` |
...
1. Update `archive/team_artifacts/audit_2026-05/_audit_raw.json` — merge `coverage_groups["group_07"]` with per-package `coverage_result`, `commands_run`, `blockers`, `added_tests`, `updated_files`.
