# Audit group group_04 — Home mode cards / preview / ordering
...
| # | Package ID |
|---:|---|
| 1 | `epoch-home-mode-card-labels` |
| 2 | `epoch-home-mode-flashcard-time-badge` |
| 3 | `epoch-home-mode-preview-drawer` |
| 4 | `epoch-home-mode-intent-ordering` |
...
1. Update `archive/team_artifacts/audit_2026-05/_audit_raw.json` — merge `coverage_groups["group_04"]` with per-package `coverage_result`, `commands_run`, `blockers`, `added_tests`, `updated_files`.
