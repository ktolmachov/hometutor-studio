...
**defense_presentation.pdf** - академическая презентация проекта home-rag_v2 для защиты.
...
1. **Титульный слайд** - home-rag: персональный AI-тьютор
2. **Обзор продукта** - проблема и решение
3. **Сравнение с конкурентами** - почему home-rag сильнее
