...
Status: open
Closure evidence: отсутствует; требуется P0-1 Authoritative Trigger Hardening (doc/next/local_model_execution_packet_plan.md) — task-write-set/tests становятся authoritative, model-декларация — только предложением-подмножеством.
```
