...
| № | Область | Статус | Файл |
|---|---|---|---|
| 1 | Судьба одного знания (петля памяти) | готово (2026-07-11) | [`01_knowledge_fate.html`](01_knowledge_fate.html) |
| 2 | Первые 10 минут (онбординг, time-to-first-insight) | план | — |
| 3 | Материал как продукт (конспект, граф, таймкоды) | план | — |
