...
|---|---|---|
| Wiring-status North star | `mixed` | №1–23 не аудированы; №24 — `wire-in-P0`; №25 SGAR — `not measurable` до E2; №26 TLRR — `wire-in-P0`, live-validated baseline 0% (2026-07-22: live-replay + аудит-фиксы P1+P2 applied, 96 тестов; grounded_explanation structural 0); №27 VLCR — `wire-in-P0`, baseline `N/A` (0 authoritative-прогонов; знаменатель равен 0) |
| Outcome после реализации | `mixed` | №1–23 не аудированы; №24/№25 — analyses provisional; №26 — implementation dry-run-observed + audit-fixes applied (2026-07-22: live-replay validated, all P1 blockers closed, 96 tests; grounded_explanation structural 0 → wave-26-grounded-explanation pending); №27 — analysis complete (E2 executed, план v1.6), implementation ⬜ |
...
| #26 Course Content Gate | [`course_content_gate_compiler_plan.md`](../../next/course_content_gate_compiler_plan.md) · [`26_course_content_gate_implementation_report.md`](../../next/26_course_content_gate_implementation_report.md) | ✅ P0-A + P0-B **dry-run-observed + audit-fixes applied** (2026-07-22): live-replay validated, все P1 блокеры закрыты (freshness best-source, micro fail-closed, scoped UI honesty), 96 тестов; раунтайм-срез README + user_guide обновлены. ⬜ Residual: grounded_explanation = structural 0 (очередь wave-26-grounded-explanation). | Live reindex 3–5 тем — сделано; post-ship replay боль-якоря — сделано; wire grounded_explanation → full TLRR 6/6; semantic entailment (#25) P1/P2 offline |
...
**#26 P0-A + P0-B полностью закрыты 2026-07-20; аудит-фиксы (P1+P2) закрыты 2026-07-22.**
Особенно важно: #18 игровая петля, #20 Мнемополис world, #21 мега-бандл и #23 B1/B2 больше не являются текущим P0/P1 backlog.

### Сводка по приоритетам (2026-07-22, после #26 аудит-фиксов)
