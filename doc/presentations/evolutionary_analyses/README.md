...
| Outcome после реализации | `mixed` | №1–23 не аудированы; №24/№25 — analyses provisional; №26 — implementation ✅ partial ship / shipped-unvalidated (2026-07-20…21; full TLRR 6/6 still structural 0); №27 — analysis complete (E2 executed), implementation ⬜ |
...
| #26 Course Content Gate | [`course_content_gate_compiler_plan.md`](../../next/course_content_gate_compiler_plan.md) · [`26_course_content_gate_implementation_report.md`](../../next/26_course_content_gate_implementation_report.md) | ✅ P0-A + P0-B **partial ship / shipped-unvalidated** (2026-07-20…21): gate packet, evidence_bound mastery gate, dual TLRR (`full` structural 0 until grounded; operational `tlrr_excluding_grounded`) | Live reindex 3–5 topics; post-ship replay боль-якоря; wire grounded_explanation; semantic entailment (#25) P1/P2 |
