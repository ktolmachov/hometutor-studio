...
Срез на 2026-07-19. Теги пересекаются: один разбор может входить в несколько
...
| **Качество квизов как самостоятельного учебного инструмента** | **0** | Квиз используется в №1, №19, №22, №23, но его валидность и качество вопросов end-to-end не разобраны |
| **Качество retrieval, цитат и ответа как учебного доказательства** | **0** | Есть смежные технические элементы, но нет отдельного пользовательского разбора |
...
**Здоровье серии.** Канонических разборов — 23; ещё 3 HTML-файла являются
мокапами №18. Формулировка North star встречается в 17 из 23 разборов, но единый
...
Для новых разборов статус метрики обязателен по правилу `North star wired` из
гайда.

| Центральный контроль | Текущий статус | Охват |
|---|---|---|
| Wiring-status North star | `not-audited` | №1–23; наличие формулировки не считается подключением |
| Outcome после реализации | `not-audited` | №1–23; зелёная runtime-галочка не считается validation |
...
**Программа следующих разборов (№24+), 2026-07-19:**
[`next_program_2026-07.html`](next_program_2026-07.html) — карта покрытия №1–23,
карта болей end-to-end пути, шесть кандидатов с оценками (P0: №24 качество квизов,
№25 groundedness ответов, №27 свой материал = полноценный урок) и главный прорывной
