...
### Сводка по приоритетам (2026-07-23, после #26 grounded-alias + verified_quiz refresh)

| Категория | Разборы |
|---|---|
| **P0 готово / structural core shipped** | #1–#23; #26 (P0 outcome закрыт, TLRR 61.1%; остались content-side residuals). №24/№25 остаются provisional analyses: #26 закрыл deterministic evidence-gate / contract wiring, но не полноценные VLQR/SGAR quality baselines и не сами P0-кандидаты №24/#25. |
| **P1 открыт** | **#27 P0-1…P0-3** — Execution Packet trust contour; **#25 semantic groundedness** — не стартовать без отдельного решения по semantic eval; #11 пересъёмка скриншотов (content-only, вне runtime scope) |
...
| Средняя готовность по всем разборам | **93.0%** |
| Взвешенная готовность с учётом важности | **~92–93%** (оценочно, без опубликованной весовой формулы; критические #25/#27 тянут вниз, #26 поднят после verified_quiz unblock) |

Категории **Structural core shipped (24)** и **Implementation не начата (3)** взаимоисключающие и
дают 27. Content-side residual #26 — подмножество core shipped, а не третье слагаемое.
...
Рекомендуемый порядок: #27 как критический engineering trust contour. #25 лучше
не начинать до отдельного решения по semantic eval, чтобы не смешивать его с
уже закрытым deterministic evidence-gate #26. #26 content-side residuals — polish,
не P0 blocker.
...
- #26 structural residual по grounded_explanation закрыт: grounded_explanation ≡ evidence_span (label_mention), tlrr_excluding_grounded deprecated.
