...
![home-rag_v2: от разрозненных документов к глубоким знаниям](../screenshots/mastery_engine/from_documents_to_deep_knowledge.png)

---

## 🎯 Главный тезис защиты

> **home-rag_v2 — это не просто система поиска по документам.**  
...
![Обзор продукта home-rag: путь от файлов к персональному AI-тьютору](../screenshots/slide_01_product_overview.png)
...
![Омниканальная локальная экосистема home-rag](../screenshots/defense_pdf/pdf_slide_09.png)
...
- home-rag_v2: гибридная архитектура с МО-персонализацией + объяснениями через языковые модели
...
- home-rag_v2: локальная ML-персонализация + LLM-объяснения
...
> **home-rag_v2 станет первой в мире локальной системой с полным AI-powered циклом обучения:**  
...
```mermaid
gantt
    title Дорожная карта home-rag_v2 2026-2027
    dateFormat YYYY-MM-DD
    section 2 кв 2026
...
![Позиционирование home-rag_v2 на рынке учебных и RAG-инструментов](../screenshots/mastery_engine/mastery_engine_slide_10.png)

![Сравнение home-rag с существующими инструментами](../screenshots/defense_pdf/pdf_slide_02.png)
...
| Нужен полный учебный цикл с персонализацией через ИИ | **home-rag_v2** — это наша ниша 🌟 |
...
> **home-rag_v2 + SSR AI Vision = будущее персонализированного обучения.**
