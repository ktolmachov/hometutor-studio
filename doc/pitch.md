# home-rag — personal tutor from your own notes
...
**home-rag собирает полный учебный цикл в одном локальном инструменте:**
...
| Возможность | ChatGPT | NotebookLM | Anki | Obsidian | **home-rag** |
|---|:---:|:---:|:---:|:---:|:---:|
...
> **«home-rag — это личный тьютор, которого ты не арендуешь у OpenAI. Он у тебя уже есть — в папке `data/`.»**

## Три фразы, которые запомнит жюри

1. **«Учебный цикл в одном инструменте — то, что ChatGPT + Anki + Obsidian делают втроём, home-rag делает сам.»**
