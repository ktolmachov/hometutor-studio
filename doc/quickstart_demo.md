...
> **Freshness:** снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · freshness gap `22` коммитов.

> Документ собран из YAML-манифесты `doc/scenarios/*.yaml` и скриншоты из `doc/screenshots/final/<scenario_id>/` после `npm run test:e2e:demo`. (съём в `doc/screenshots/<RUN>/`; перед этим генератор пересобирает `doc/screenshots/final/`, **ссылки ведут в `final/`**). Не правь вручную — манифесты и `python scripts/generate_demo_doc.py`.
...
- [scenario_31 — Честный сбой LLM: локальный endpoint недоступен](#scenario-31-честный-сбой-llm-локальный-endpoint-недоступен) — ✅
- [scenario_32 — Публичное демо на HF Spaces: без установки и без своего LLM](#scenario-32-публичное-демо-на-hf-spaces-без-установки-и-без-своего-llm) — ✅
- [scenario_33 — Экспорт живой карты: интерактивный HTML одним кликом](#scenario-33-экспорт-живой-карты-интерактивный-html-одним-кликом) — ✅
- [scenario_34 — Возврат в таймкод видео: контекст без пересмотра](#scenario-34-возврат-в-таймкод-видео-контекст-без-пересмотра) — ✅
- [scenario_35 — Приватность и offline-проверка: данные не покидают устройство](#scenario-35-приватность-и-offline-проверка-данные-не-покидают-устройство) — ✅
- [scenario_36 — Маршрут дня: авто-выбор узлов по ценности](#scenario-36-маршрут-дня-авто-выбор-узлов-по-ценности) — ✅
- [scenario_37 — Конспект: паспорт, статусы и счётчики](#scenario-37-конспект-паспорт-статусы-и-счётчики) — ✅
- [scenario_38 — Оформление: миры темы](#scenario-38-оформление-миры-темы) — ✅
...
| `scenario_31` | Честный сбой LLM: локальный endpoint недоступен | 🔵 Trust drill-down | 3/3 | нет | ✅ полностью снят |
| `scenario_32` | Публичное демо на HF Spaces: без установки и без своего LLM | 🟢 Первые шаги | 3/3 | нет | ✅ полностью снят |
| `scenario_33` | Экспорт живой карты: интерактивный HTML одним кликом | 🔴 Mastery | 3/3 | нет | ✅ полностью снят |
| `scenario_34` | Возврат в таймкод видео: контекст без пересмотра | 🟠 Retention engine | 4/4 | нет | ✅ полностью снят |
| `scenario_35` | Приватность и offline-проверка: данные не покидают устройство | 🟢 Первые шаги | 4/4 | нет | ✅ полностью снят |
| `scenario_36` | Маршрут дня: авто-выбор узлов по ценности | 🔴 Mastery | 1/1 | нет | ✅ полностью снят |
| `scenario_37` | Конспект: паспорт, статусы и счётчики | 🟠 Retention engine | 3/3 | нет | ✅ полностью снят |
| `scenario_38` | Оформление: миры темы | 🟢 Everyday UX | 1/1 | нет | ✅ полностью снят |
...
<sub>файл: `doc/screenshots/final/scenario_01/demo.gif` · 783 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:57:34.274Z`
- Финиш: `2026-07-14T17:57:41.567Z`
- Статус: `passed`
...
<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>
...
<sub>файл: `doc/screenshots/final/scenario_02/demo.gif` · 649 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:57:41.656Z`
- Финиш: `2026-07-14T17:57:47.082Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_03/demo.gif` · 724 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:57:47.175Z`
- Финиш: `2026-07-14T17:57:55.304Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_04/demo.gif` · 508 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:57:55.398Z`
- Финиш: `2026-07-14T17:57:58.764Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_05/demo.gif` · 511 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:57:58.850Z`
- Финиш: `2026-07-14T17:58:04.663Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_06/demo.gif` · 609 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:04.744Z`
- Финиш: `2026-07-14T17:58:10.380Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_07/demo.gif` · 600 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:10.466Z`
- Финиш: `2026-07-14T17:58:14.371Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_08/demo.gif` · 571 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:14.451Z`
- Финиш: `2026-07-14T17:58:17.949Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_09/demo.gif` · 746 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:18.035Z`
- Финиш: `2026-07-14T17:58:22.147Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_10/demo.gif` · 433 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:22.225Z`
- Финиш: `2026-07-14T17:58:26.331Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_11/demo.gif` · 411 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:26.419Z`
- Финиш: `2026-07-14T17:58:29.228Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_12/demo.gif` · 364 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:29.313Z`
- Финиш: `2026-07-14T17:58:33.329Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_13/demo.gif` · 308 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:33.424Z`
- Финиш: `2026-07-14T17:58:38.539Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_14/demo.gif` · 265 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:38.630Z`
- Финиш: `2026-07-14T17:58:41.115Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_15/demo.gif` · 439 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:58:41.208Z`
- Финиш: `2026-07-14T17:59:38.595Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_16/demo.gif` · 547 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:59:38.682Z`
- Финиш: `2026-07-14T17:59:44.726Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_17/demo.gif` · 555 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:59:44.819Z`
- Финиш: `2026-07-14T17:59:48.315Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_18/demo.gif` · 529 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:59:48.395Z`
- Финиш: `2026-07-14T17:59:53.466Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_19/demo.gif` · 390 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:59:53.554Z`
- Финиш: `2026-07-14T17:59:59.665Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_20/demo.gif` · 424 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T17:59:59.753Z`
- Финиш: `2026-07-14T18:00:04.122Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_21/demo.gif` · 424 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:04.214Z`
- Финиш: `2026-07-14T18:00:08.604Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_22/demo.gif` · 773 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:08.707Z`
- Финиш: `2026-07-14T18:00:10.151Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_23/demo.gif` · 389 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:10.236Z`
- Финиш: `2026-07-14T18:00:16.268Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_24/demo.gif` · 368 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:16.358Z`
- Финиш: `2026-07-14T18:00:20.934Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_25/demo.gif` · 599 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:21.016Z`
- Финиш: `2026-07-14T18:00:24.233Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_26/demo.gif` · 520 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:24.316Z`
- Финиш: `2026-07-14T18:00:53.934Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_27/demo.gif` · 572 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:00:54.022Z`
- Финиш: `2026-07-14T18:01:22.529Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_28/demo.gif` · 622 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:01:22.615Z`
- Финиш: `2026-07-14T18:01:26.228Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_29/demo.gif` · 429 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:01:26.309Z`
- Финиш: `2026-07-14T18:01:31.008Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
<sub>файл: `doc/screenshots/final/scenario_30/demo.gif` · 389 KB · собран через `python scripts/make_demo_gifs.py`</sub>
...
- Старт: `2026-07-14T18:01:31.097Z`
- Финиш: `2026-07-14T18:01:36.796Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
## scenario_31 — Честный сбой LLM: локальный endpoint недоступен

**🔵 Trust drill-down** · ⏱ 2 мин · 👤 Аня работает офлайн — LM Studio не запущена. Хочет понять, что происходит, не читая логи.

**Зачем:** Показать, что hometutor не молчит и не зависает при сбое LLM: circuit breaker
(app/llm_resilience.py, app/llm_local_circuit.py) быстро размыкается на живом трафике,
а UI показывает конкретную причину и конкретное действие вместо общей ошибки.

> 🔥 **Wow-момент:** Вместо зависания на десятки секунд — за пару секунд конкретный баннер: "Локальная LLM
недоступна — SSR работает в template-режиме" с адресом endpoint'а, именем нужной модели
и инструкцией запустить LM Studio.

### Анимированный разбор

![Честный сбой LLM: локальный endpoint недоступен](screenshots/final/scenario_31/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_31/demo.gif` · 390 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Баннер: локальная LLM недоступна

![Баннер: локальная LLM недоступна](screenshots/final/scenario_31/01_llm_local_banner_reachable_false.png)

_«Локальная LLM недоступна — SSR работает в template-режиме»: endpoint не отвечает, карточка формируется по шаблону без персонализации._

<sub>файл: `doc/screenshots/final/scenario_31/01_llm_local_banner_reachable_false.png` · ⏱ 4s</sub>

#### Шаг 2 — Конкретное действие: какой сервер запустить и какую модель загрузить

![Конкретное действие: какой сервер запустить и какую модель загрузить](screenshots/final/scenario_31/02_banner_action_hint.png)

_Баннер называет base_url и модель — запустите LM Studio и загрузите именно её._

<sub>файл: `doc/screenshots/final/scenario_31/02_banner_action_hint.png` · ⏱ 3s</sub>

#### Шаг 3 — Раскрытые детали диагностики: base_url и модель одной строкой

![Раскрытые детали диагностики: base_url и модель одной строкой](screenshots/final/scenario_31/03_diagnostics_expander.png)

_Expander «Подробности диагностики local LLM» — тот же base_url/model в code-блоке._

<sub>файл: `doc/screenshots/final/scenario_31/03_diagnostics_expander.png` · ⏱ 3s</sub>
...
- Старт: `2026-07-14T18:01:36.886Z`
- Финиш: `2026-07-14T18:01:41.911Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** LLM-сбой не равен сбою приложения: быстрый честный отказ + названная причина +
конкретное действие = доверие к системе в неидеальных условиях.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-31--честный-сбой-llm-локальный-endpoint-недоступен)

---

## scenario_32 — Публичное демо на HF Spaces: без установки и без своего LLM

**🟢 Первые шаги** · ⏱ 2 мин · 👤 Лена нашла ссылку на публичный Space и хочет попробовать без установки чего-либо на свой компьютер.

**Зачем:** Показать, что hometutor можно попробовать за пару минут на публичной ссылке
Hugging Face Spaces: не нужно ставить Python, LM Studio или собирать индекс —
всё уже развёрнуто и работает на предзагруженном демо-корпусе.

> 🔥 **Wow-момент:** Ни одной команды в терминале, ни одного локального сервера: за пару минут после
открытия ссылки и короткой регистрации Лена уже задаёт вопросы по предзагруженному
курсу и видит ответы с источниками.

### Анимированный разбор

![Публичное демо на HF Spaces: без установки и без своего LLM](screenshots/final/scenario_32/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_32/demo.gif` · 390 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Публичная ссылка HF Space: README и статус

![Публичная ссылка HF Space: README и статус](screenshots/final/scenario_32/01_hf_spaces_public_url.png)

_Открывает ссылку — сразу видно, что это работающий, а не спящий Space._

<sub>файл: `doc/screenshots/final/scenario_32/01_hf_spaces_public_url.png` · ⏱ 3s</sub>

#### Шаг 2 — Короткая регистрация: email + пароль

![Короткая регистрация: email + пароль](screenshots/final/scenario_32/02_quick_signup.png)

_AUTH_ENABLED=true — обычная быстрая регистрация, без ключей и настроек._

<sub>файл: `doc/screenshots/final/scenario_32/02_quick_signup.png` · ⏱ 3s</sub>

#### Шаг 3 — Первый ответ по предзагруженному демо-курсу

![Первый ответ по предзагруженному демо-курсу](screenshots/final/scenario_32/03_demo_course_first_answer.png)

_Демо-корпус уже в индексе — вопрос и ответ с источниками сразу после входа._

<sub>файл: `doc/screenshots/final/scenario_32/03_demo_course_first_answer.png` · ⏱ 4s</sub>
...
- Старт: `2026-07-14T18:01:42.006Z`
- Финиш: `2026-07-14T18:01:46.890Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** Публичная витрина — не замена local-first дома, а входной билет: попробовать
можно без установки; данные и приватность остаются архитектурой локального режима.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-32--публичное-демо-на-hf-spaces-без-установки-и-без-своего-llm)

---

## scenario_33 — Экспорт живой карты: интерактивный HTML одним кликом

**🔴 Mastery** · ⏱ 2 мин · 👤 Марк хочет забрать карту знаний курса и открыть её без приложения, даже offline.

**Зачем:** Показать, что Knowledge Graph — не запертый в Streamlit виджет: кнопка «Скачать
живую карту (HTML)» отдаёт самодостаточный интерактивный файл (узлы, связи, mastery),
который открывается в любом браузере без интернета и без hometutor.

> 🔥 **Wow-момент:** Один клик — и на диске файл knowledge_graph.html: та же интерактивная карта, что и
в приложении, но открывается двойным кликом в браузере, работает офлайн и её можно
переслать одногруппнику без установки hometutor.

### Анимированный разбор

![Экспорт живой карты: интерактивный HTML одним кликом](screenshots/final/scenario_33/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_33/demo.gif` · 390 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Панель Knowledge Graph: кнопка «Скачать живую карту (HTML)»

![Панель Knowledge Graph: кнопка «Скачать живую карту (HTML)»](screenshots/final/scenario_33/01_kg_panel_download_button.png)

_Кнопка стоит прямо под интерактивным графом — рядом со сводкой концептов._

<sub>файл: `doc/screenshots/final/scenario_33/01_kg_panel_download_button.png` · ⏱ 3s</sub>

#### Шаг 2 — knowledge_graph.html открыт отдельно в браузере

![knowledge_graph.html открыт отдельно в браузере](screenshots/final/scenario_33/02_downloaded_html_opened_standalone.png)

_Тот же граф, та же интерактивность — но уже не внутри Streamlit, а как обычный файл._

<sub>файл: `doc/screenshots/final/scenario_33/02_downloaded_html_opened_standalone.png` · ⏱ 4s</sub>

#### Шаг 3 — Файл работает без сети и без приложения

![Файл работает без сети и без приложения](screenshots/final/scenario_33/03_offline_share_moment.png)

_Отключил интернет, открыл файл заново — граф на месте: можно отправить кому угодно._

<sub>файл: `doc/screenshots/final/scenario_33/03_offline_share_moment.png` · ⏱ 3s</sub>
...
- Старт: `2026-07-14T18:01:46.977Z`
- Финиш: `2026-07-14T18:01:52.141Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** Живая карта не заперта внутри UI: экспорт в самодостаточный HTML делает её
переносимой и вечной — файл переживает и сессию, и сам продукт.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-33--экспорт-живой-карты-интерактивный-html-одним-кликом)
...
![Возврат в таймкод видео: контекст без пересмотра](screenshots/final/scenario_34/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_34/demo.gif` · 520 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Старт видео-сессии: плеер + конспект

![Старт видео-сессии: плеер + конспект](screenshots/final/scenario_34/01_video_session_started.png)

_Пользователь открывает лекцию; система фиксирует таймкод 00:00._

<sub>файл: `doc/screenshots/final/scenario_34/01_video_session_started.png` · ⏱ 4s</sub>

#### Шаг 2 — Сессия прервана: таймкод 23:15 сохранён

![Сессия прервана: таймкод 23:15 сохранён](screenshots/final/scenario_34/02_interrupted_session_state.png)

_После выхода learner state хранит позицию — 23:15, тема, ключевые тезисы._

<sub>файл: `doc/screenshots/final/scenario_34/02_interrupted_session_state.png` · ⏱ 3s</sub>

#### Шаг 3 — Resume-карта с таймкодом на главном экране

![Resume-карта с таймкодом на главном экране](screenshots/final/scenario_34/03_resume_video_card.png)

_При возврате — «Продолжить с 23:15» + конспект 3–5 ключевых тезисов._

<sub>файл: `doc/screenshots/final/scenario_34/03_resume_video_card.png` · ⏱ 4s</sub>

#### Шаг 4 — Контекст готов: вопросы по просмотренному фрагменту

![Контекст готов: вопросы по просмотренному фрагменту](screenshots/final/scenario_34/04_qa_after_video_segment.png)

_Система знает, о чём был фрагмент, и может ответить на вопросы._

<sub>файл: `doc/screenshots/final/scenario_34/04_qa_after_video_segment.png` · ⏱ 3s</sub>
...
- Старт: `2026-07-14T18:01:52.228Z`
- Финиш: `2026-07-14T18:01:57.990Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
**Зачем:** Ключевое обещание hometutor — local-first. Сценарий доказывает через сетевой
трафик и код, а не рекламный текст: без облачного провайдера поиск, ответы и SM-2
повторение работают через локальный Chroma/SQLite/LM Studio, без внешних запросов.

> 🔥 **Wow-момент:** Отключил Wi-Fi, запустил hometutor — поиск по материалам, ответы с источниками и
повторение карточек по SM-2 работают. Вкладка сети пуста, кроме localhost.

### Анимированный разбор

![Приватность и offline-проверка: данные не покидают устройство](screenshots/final/scenario_35/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_35/demo.gif` · 520 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Диагностика: локальный LLM endpoint и offline-статус

![Диагностика: локальный LLM endpoint и offline-статус](screenshots/final/scenario_35/01_offline_status_diagnostics.png)

_Система прозрачно показывает, какой endpoint используется и достижим ли он._

<sub>файл: `doc/screenshots/final/scenario_35/01_offline_status_diagnostics.png` · ⏱ 3s</sub>

#### Шаг 2 — Ответ без сети: retrieval из Chroma + источник ответа

![Ответ без сети: retrieval из Chroma + источник ответа](screenshots/final/scenario_35/02_offline_answer_with_source.png)

_Поиск по локальному индексу, источник ответа виден явно, а не скрыт._

<sub>файл: `doc/screenshots/final/scenario_35/02_offline_answer_with_source.png` · ⏱ 4s</sub>

#### Шаг 3 — SM-2 повторение карточек полностью офлайн

![SM-2 повторение карточек полностью офлайн](screenshots/final/scenario_35/03_offline_srs_review.png)

_Оценка «Легко/Хорошо/Забыл» и пересчёт интервала — чистый алгоритм, без LLM._

<sub>файл: `doc/screenshots/final/scenario_35/03_offline_srs_review.png` · ⏱ 3s</sub>

#### Шаг 4 — Network tab: ноль внешних запросов

![Network tab: ноль внешних запросов](screenshots/final/scenario_35/04_network_tab_clean.png)

_Вкладка сети пуста, кроме localhost: полная изоляция во время сессии._

<sub>файл: `doc/screenshots/final/scenario_35/04_network_tab_clean.png` · ⏱ 3s</sub>
...
- Старт: `2026-07-14T18:01:58.078Z`
- Финиш: `2026-07-14T18:02:03.276Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`
...
= учебная среда, где SRS и retrieval не требуют интернета в принципе.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-35--приватность-и-offline-проверка-данные-не-покидают-устройство)

---

## scenario_36 — Маршрут дня: авто-выбор узлов по ценности

**🔴 Mastery** · ⏱ 2 мин · 👤 Марк готовится к экзамену и хочет не просто красивый граф, а короткий список узлов, с которых сегодня выгоднее начать.

**Зачем:** Показать, что Knowledge Graph умеет выбирать следующий учебный маршрут по worth:
due, novelty, decay, frontier и reach складываются в конкретные остановки на день.

> 🔥 **Wow-момент:** Кнопка «Авто: маршрут дня» превращает карту знаний в маршрут из нескольких остановок по ценности.

### Анимированный разбор

![Маршрут дня: авто-выбор узлов по ценности](screenshots/final/scenario_36/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_36/demo.gif` · 145 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Knowledge Graph: авто-маршрут дня

![Knowledge Graph: авто-маршрут дня](screenshots/final/scenario_36/01_route_day_auto.png)

_Один клик выбирает 4–6 узлов с максимальной учебной ценностью и подсвечивает путь на графе._

<sub>файл: `doc/screenshots/final/scenario_36/01_route_day_auto.png` · ⏱ 6s</sub>
...
- Старт: `2026-07-14T18:49:41.800Z`
- Финиш: `2026-07-14T18:50:09.631Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** Граф не декоративный: он помогает решить, что учить сейчас, а что можно оставить на потом.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-36--маршрут-дня-авто-выбор-узлов-по-ценности)

---

## scenario_37 — Конспект: паспорт, статусы и счётчики

**🟠 Retention engine** · ⏱ 3 мин · 👤 Аня читает живой конспект и хочет понимать не только текст, но и качество источника, свой статус по разделам и остаток открытых вопросов.

**Зачем:** Зафиксировать свежие фичи Живого конспекта: паспорт качества, статусы «Понял / Сомневаюсь / Не понял»
и счётчики, которые превращают чтение в управляемую учебную работу.

> 🔥 **Wow-момент:** Конспект показывает качество и прогресс прямо рядом с разделом: не надо помнить в голове, что уже закрыто.

### Анимированный разбор

![Конспект: паспорт, статусы и счётчики](screenshots/final/scenario_37/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_37/demo.gif` · 454 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Паспорт качества конспекта

![Паспорт качества конспекта](screenshots/final/scenario_37/01_konspekt_quality_passport.png)

_Рубрика качества раскрывается рядом с разделом и показывает, где есть проверка точности._

<sub>файл: `doc/screenshots/final/scenario_37/01_konspekt_quality_passport.png` · ⏱ 5s</sub>

#### Шаг 2 — Статусы раздела: понял, сомневаюсь, не понял

![Статусы раздела: понял, сомневаюсь, не понял](screenshots/final/scenario_37/02_konspekt_status_controls.png)

_После чтения можно зафиксировать состояние знания и оставить вопрос тьютору._

<sub>файл: `doc/screenshots/final/scenario_37/02_konspekt_status_controls.png` · ⏱ 5s</sub>

#### Шаг 3 — Счётчики прогресса по конспекту

![Счётчики прогресса по конспекту](screenshots/final/scenario_37/03_konspekt_status_counters.png)

_Система собирает статусы в общий обзор: что закрыто, что сомнительно, где остались вопросы._

<sub>файл: `doc/screenshots/final/scenario_37/03_konspekt_status_counters.png` · ⏱ 5s</sub>
...
- Старт: `2026-07-14T18:50:09.722Z`
- Финиш: `2026-07-14T18:50:16.991Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** Хороший конспект в hometutor — это не статичный markdown, а рабочая поверхность с качеством, статусами и вопросами.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-37--конспект-паспорт-статусы-и-счётчики)

---

## scenario_38 — Оформление: миры темы

**🟢 Everyday UX** · ⏱ 2 мин · 👤 Аня учится вечером и хочет выбрать спокойную цветовую схему, чтобы интерфейс меньше утомлял.

**Зачем:** Показать, что оформление — это не косметика ради косметики: пользователь может выбрать визуальный мир
и сохранить его локально в своём профиле.

> 🔥 **Wow-момент:** Панель «Оформление» показывает готовые миры: Лес, Океан, Закат, Космос и Ягода.

### Анимированный разбор

![Оформление: миры темы](screenshots/final/scenario_38/demo.gif)

<sub>файл: `doc/screenshots/final/scenario_38/demo.gif` · 92 KB · собран через `python scripts/make_demo_gifs.py`</sub>

<details><summary><b>Статичная раскадровка (кадр за кадром)</b></summary>

#### Шаг 1 — Панель оформления: миры темы

![Панель оформления: миры темы](screenshots/final/scenario_38/01_appearance_worlds.png)

_Пять цветовых миров помогают быстро подобрать комфортный режим чтения и повторения._

<sub>файл: `doc/screenshots/final/scenario_38/01_appearance_worlds.png` · ⏱ 6s</sub>
...
- Старт: `2026-07-14T18:50:17.078Z`
- Финиш: `2026-07-14T18:50:20.837Z`
- Статус: `passed`
- Env: `HOME_RAG_E2E_OFFLINE=1, E2E_API_PORT=18000, E2E_STREAMLIT_PORT=18501`

</details>

**Takeaway:** Hometutor можно настроить под себя без изменения учебных данных и без облака.

<sub>Freshness: снято на HEAD `8305ca588` · текущий HEAD `e1d59c9a1` · gap `22` коммитов</sub>

[→ Полный сценарий в каталоге](user_scenarios.md#сценарий-38--оформление-миры-темы)
